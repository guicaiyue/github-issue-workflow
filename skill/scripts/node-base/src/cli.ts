...
type PayloadTarget = "fix" | "test" | "review" | "split";
...
function parseState(args: string[]): IssueState {
...
function parsePayloadTarget(args: string[]): PayloadTarget {
...
async function run(): Promise<void> {
  ...
  const service = new IssueWorkflowService();
